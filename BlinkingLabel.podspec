...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/anthony-fabrizi/BlinkingLabel'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'anthony-fabrizi' => 'anthony.fabrizi@me.com' }
  s.source           = { :git => 'https://github.com/anthony-fabrizi/BlinkingLabel.git', :tag => s.version.to_s }
